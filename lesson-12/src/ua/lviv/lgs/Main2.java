...
public class Main2 {
	...
	public static void viewMonth6() {
		...
		if(flag) {
			...
			int length = seasonsList.size();
			if(value < length-1) {
				System.out.println("Next season is: " + seasonsList.get(value+1));
			} else if (value == length-1) {
				System.out.println("Next season is: " + seasonsList.get(0));
			}
		}
		else {
			System.out.println("Season doesn't exist");
	...
	public static void viewMonth7() {
		...
		if(flag) {
			...
			int length = seasonsList.size();
			if(value == 0) {
				System.out.println("Previous season is: " + seasonsList.get(length-1));
			} else if (value > 0) {
				System.out.println("Previous season is: " + seasonsList.get(value-1));
			}
		}
		else {
			System.out.println("Season doesn't exist");
